                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-heading fw-bold">sipasti</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <p class="mb-6 text-center">Silahkan login terlebih dahulu</p>

                        <form role="form" class="mb-6" action="{{ route('login') }}" method="POST">
                            @csrf
                            <div class="mb-6">
                                <label for="username" class="form-label">Username</label>
                                <input type="text" class="form-control @error('loginError') is-invalid @enderror"
                                    id="username" name="username" aria-label="username" placeholder="username"
