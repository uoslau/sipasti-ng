<div class="tab-content border-top">
    <form method="POST" action="{{ route('rpd.store') }}">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="mb-6">
                    <label class="form-label" for="rpd_kegiatan">Kegiatan</label>
                    <input type="text" class="form-control @error('rpd_kegiatan') is-invalid @enderror"
                        id="rpd_kegiatan" name="rpd_kegiatan" placeholder="contoh: Dukman, PPIS" required autofocus
            ...
            <div class="col-md-6">
                <div class="mb-6">
                    ...
                    <input type="text" class="form-control @error('rpd_jenis_belanja') is-invalid @enderror"
                        id="rpd_jenis_belanja" name="rpd_jenis_belanja" placeholder="contoh: Belanja Barang" required
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-6">
                    ...
                    <input type="text" class="form-control @error('rpd_output') is-invalid @enderror" id="rpd_output"
            ...
            <div class="col-md-6">
                <div class="mb-6">
                    ...
                    <input class="form-control" type="text" value="{{ old('rpd_target') }}" id="rpd_target"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-6">
                    ...
                    <input class="form-control" type="text" value="{{ old('rpd_realisasi') }}" id="rpd_realisasi"
            ...
            <div class="col-md-6">
                <div class="mb-6">
                    ...
                    <input type="text" class="form-control @error('rpd_pic') is-invalid @enderror" id="rpd_pic"
                        name="rpd_pic" placeholder="contoh: Epianus Zega" required autofocus
                        value="{{ old('rpd_pic') }}" />
                    @error('rpd_pic')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-6">
                    ...
                    <select class="form-select" id="rpd_bulan" name="rpd_bulan">
            ...
            <div class="col-md-12">
                <div class="mb-6">
                    ...
                    <textarea class="form-control @error('rpd_catatan') is-invalid @enderror" id="rpd_catatan" name="rpd_catatan"
